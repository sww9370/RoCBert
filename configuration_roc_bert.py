...
class RoCBertConfig(PretrainedConfig):
    ...
    Args:
        ...
        merge_input_way (`str`, *optional*, defaults to `concat`):
            Defines the way of merging the shape_embed, pronunciation_embed and word_embed, if the value is "concat",
            output_embed = torch.cat((word_embed, shape_embed, pronunciation_embed), -1), elif the calue is "plus"
            output_embed = (word_embed + shape_embed + pronunciation_embed) / 3, elif the calue is "attention", # todo:
            添加attention公式
        additional_attention_layer (`int`, *optional*, defaults to 0):
            Defines the layer to insert the attention layer for shape_embed and pronunciation_embed when the
            merge_input_way="attention"
        Example:
    ...
    def __init__(
        ...
        merge_input_way="concat",
        additional_attention_layer=0,
        **kwargs
    ):
        ...
        self.merge_input_way = merge_input_way
        self.position_embedding_type = position_embedding_type
        self.classifier_dropout = classifier_dropout
        self.additional_attention_layer = additional_attention_layer
